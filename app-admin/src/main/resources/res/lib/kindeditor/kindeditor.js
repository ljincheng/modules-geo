...
(function(window, undefined) {
    ...
    function _getInitHtml(themesPath, bodyClass, cssPath, cssData,htmlBasePath) {
        var arr = [
        ...
        if(htmlBasePath)
        {
            arr.push('<base href="'+htmlBasePath+'"/>');
        }
        if(!_isArray(cssPath)) {
            cssPath = [cssPath];
        }
    ...
    _extend(KEdit, KWidget, {
        init: function(options) {
            ...
            var htmlBasePath=options.htmlBasePath;
            ...
            function ready() {
                ...
                doc.write(_getInitHtml(themesPath, bodyClass, cssPath, cssData,htmlBasePath));
                doc.close();
    ...
    KEditor.prototype = {
        ...
        create: function() {
            ...
            var edit = self.edit = _edit({
                ...
                htmlBasePath:self.htmlBasePath,
