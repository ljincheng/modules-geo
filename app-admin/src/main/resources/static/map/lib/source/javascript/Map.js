...
//					if(Math.abs(dx-this.lastpos[0])>5 && Math.abs(dy-this.lastpos[1])>5){//大小2PX情况才通知
						this.dragingLayer();
						this.lastpos=[dx,dy];
//					}
        		}
...
//            }
        ...
        setLevel:function(z,refreshmap)//待完善
        {
